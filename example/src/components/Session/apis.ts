...
export const openEnterpriseChat = async () => {
  ...
  await jsSdk.asyncCall('openEnterpriseChat', {
...
export const updateEnterpriseChat = async () => {
  try {
    ...
    const userId = getUserId();
    const res = await jsSdk.invoke('updateEnterpriseChat', {
...
export const openExistedChatWithMsg = async () => {
  try {
    const externalChatId = await getCurExternalChat();
    const res = await jsSdk.invoke('openExistedChatWithMsg', {
...
export const hideChatAttachmentMenu = async () => {
  try {
    const res = await jsSdk.invoke('hideChatAttachmentMenu', {
...
export const sendChatMessage = async () => {
  const res = await jsSdk.invoke('sendChatMessage', {
...
export const setShareAttr = async () => {
  const res = await jsSdk.invoke('setShareAttr', {
...
export const getShareInfo = async () => {
  try {
    ...
    const res = await jsSdk.invoke('getShareInfo', {
...
export const createCorpGroupChat = async () => {
  try {
    ...
    const res = await jsSdk.invoke('createCorpGroupChat', {
...
export const updateCorpGroupChat = async () => {
  try {
    const externalChatId = await getCurExternalChat();
    const userId = await getUserId();
    const res = await jsSdk.invoke('updateCorpGroupChat', {
      chatId: externalChatId,
      userIdsToAdd: [userId]
    })
