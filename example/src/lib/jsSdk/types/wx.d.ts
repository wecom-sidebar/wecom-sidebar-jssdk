declare namespace wx {
  ...
  declare function onNetworkStatusChange(callback: (params: OnNetworkStatusChangeCallbackRes) => void)
  ...
  // 监听连接上 Wi-Fi 的事件
  declare function onWifiConnected(callback: WxFnCallback<OnWifiConnectedParams>)
  ...
  // 获取本机蓝牙适配器状态
  declare function getBluetoothAdapterState(params: GetBluetoothAdapterStateParams)

  // 监听蓝牙适配器状态变化事件
  declare function onBluetoothAdapterStateChange(callback: OnBluetoothAdapterStateChangeCallback);

  // 开始搜寻附近的蓝牙外围设备
  declare function startBluetoothDevicesDiscovery(params: StartBluetoothDevicesDiscoveryParams)

  // 停止搜寻附近的蓝牙外围设备
  declare function stopBluetoothDevicesDiscovery(params: StopBluetoothDevicesDiscoveryParams);
  ...
  declare function getConnectedBluetoothDevices(params: GetConnectedBluetoothDevicesParams);
  ...
  // 监听低功耗蓝牙连接状态的改变事件
  declare function onBLEConnectionStateChange(callback: (res: OnBLEConnectionStateChangeRes) => void)

  // 获取蓝牙设备所有 service（服务）
  declare function getBLEDeviceServices(params: GetBLEDeviceServicesParams)

  declare function getBLEDeviceCharacteristics(params: GetBLEDeviceCharacteristicsParams)

  // 监听变化
  declare function onBLECharacteristicValueChange(callback: (res: OnBLECharacteristicValueChangeRes) => void);

  // 读取低功耗蓝牙设备的特征值的二进制数据值。
  declare function readBLECharacteristicValue(params: ReadBLECharacteristicValueParams);

  // 向低功耗蓝牙设备特征值中写入二进制数据
  declare function writeBLECharacteristicValue(params: WriteBLECharacteristicValueParams)

  // 启用低功耗蓝牙设备特征值变化时的 notify 功能，订阅特征值
  declare function notifyBLECharacteristicValueChange(params: NotifyBLECharacteristicValueChangeParams)
  ...
  // 监听 iBeacon 的服务变化
  declare function onBeaconServiceChange(callback: (res: OnBeaconServiceChangeRes) => void);
  ...
  // 监听地理位置变化
  declare function onLocationChange(callback: (res: OnLocationChangeRes) => void)
  ...
  declare function invoke(api: 'getContext', params: {}, callback: WxInvokeCallback<GetContextRes>);
  ...
  declare function invoke(api: 'sendChatMessage', params: SendChatMessageParams, callback: WxInvokeCallback)
  ...
  declare function invoke(api: 'shareAppMessage', params: ShareAppMessageParams, callback: WxInvokeCallback);

  // 自定义转发到微信
  // 详见：https://open.work.weixin.qq.com/api/doc/90001/90144/90523
  declare function invoke(api: 'shareWechatMessage', params: ShareWechatMessageParams, callback: WxInvokeCallback);
